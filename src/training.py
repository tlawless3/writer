# source for some of this code https://www.tensorflow.org/tutorials/sequences/text_generation
...
# uncomment everything under here unitl comment to train model on data in outputTxtFile
